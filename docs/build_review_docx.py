# -*- coding: utf-8 -*-
"""将 用户操作手册.md 转换为 用户操作手册.docx（python-docx）。"""
...
MD_PATH = BASE / "系统功能评审与改进建议.md"
OUT_PATH = BASE / "系统功能评审与改进建议.docx"
...
def setup_header_footer(doc):
    ...
    run = hp.add_run("“潭合同”台账管理系统 · 系统功能评审与改进建议")
...
def main():
    ...
    doc.core_properties.title = "“潭合同”台账管理系统 用户操作手册"
        ...
        if kind == "h":
            ...
            if level == 1:
                if not title_done:
                    ...
                    add_inline(sp, "系统功能评审与改进建议", size=16, bold=True, color=H1_COLOR)
                    title_done = True
                    continue
