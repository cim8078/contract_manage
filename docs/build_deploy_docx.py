# -*- coding: utf-8 -*-
"""将 系统部署手册.md 转换为 系统部署手册.docx（python-docx）。"""
...
MD_PATH = BASE / "系统部署手册.md"
OUT_PATH = BASE / "系统部署手册.docx"
...
def setup_header_footer(doc):
    ...
    run = hp.add_run("“潭合同”台账管理系统 · 系统部署手册")
        ...
        if kind == "h":
            ...
            if level == 1:
                if not title_done:
                    ...
                    add_inline(sp, "系统部署手册", size=16, bold=True, color=H1_COLOR)
                    title_done = True
                    continue
